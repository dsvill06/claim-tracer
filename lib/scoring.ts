...
export interface Source { url: string; domain: string; type: SourceType; stance: Stance }
...
export const inputPlaceholder='Paste the post, thread, or article text…'
