...
export const splitterPrompt=`You extract checkable factual claims from text. Return ONLY valid JSON: {"claims":["..."]}. Make claims atomic, checkable against external sources. Exclude: opinions, predictions, values, jokes, rhetoric, feelings, article metadata (publication dates, timestamps, author names, bylines, publisher names). Maximum 8 claims; return [] if none.`
